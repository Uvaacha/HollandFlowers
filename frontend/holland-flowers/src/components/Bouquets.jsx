...
const Bouquets = () => {
  ...
  const translations = {
    en: {
      title: "Flower Bouquets", subtitle: "Beautiful hand-arranged flower bouquets for every occasion", badge: "BOUQUETS",
    ...
    ar: {
      title: "باقات الزهور", subtitle: "باقات زهور جميلة مرتبة يدوياً لكل مناسبة", badge: "باقات",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'flower bouquets' || name.includes('flower');
        });
