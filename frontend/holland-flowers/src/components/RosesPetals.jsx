...
const RosesPetals = () => {
  ...
  const translations = {
    en: {
      title: "Roses Petals", subtitle: "Fresh rose petals for romantic occasions", badge: "ROSE PETALS",
    ...
    ar: {
      title: "بتلات الورد", subtitle: "بتلات ورد طازجة للمناسبات الرومانسية", badge: "بتلات ورد",
  ...
  return (
    <div className={`rosespetals-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
