...
const TulipsArrangement = () => {
  ...
  const translations = {
    en: {
      title: "Tulips Arrangement", subtitle: "Fresh tulips in beautiful arrangements", badge: "TULIPS",
    ...
    ar: {
      title: "تنسيقات التوليب", subtitle: "توليب طازج في تنسيقات جميلة", badge: "توليب",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'tulips' || name.includes('tulips');
        });
  ...
  return (
    <div className={`tulipsarrangement-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
