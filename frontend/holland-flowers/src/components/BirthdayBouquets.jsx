...
const BirthdayBouquets = () => {
  ...
  const translations = {
    en: {
      title: "Birthday Bouquets", subtitle: "Celebrate birthdays with our festive flower arrangements", badge: "BIRTHDAY",
    ...
    ar: {
      title: "باقات عيد الميلاد", subtitle: "احتفل بأعياد الميلاد مع تنسيقات الزهور الاحتفالية", badge: "عيد الميلاد",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'birthday bouquet' || name.includes('birthday');
        });
  ...
  return (
    <div className={`birthdaybouquets-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
