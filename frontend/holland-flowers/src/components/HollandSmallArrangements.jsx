...
const HollandSmallArrangements = () => {
  ...
  const translations = {
    en: {
      title: "Holland Small Arrangements", subtitle: "Compact Dutch-style arrangements perfect for any space", badge: "SMALL ARRANGEMENTS",
    ...
    ar: {
      title: "تنسيقات هولندية صغيرة", subtitle: "تنسيقات هولندية صغيرة مثالية لأي مكان", badge: "تنسيقات صغيرة",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'holland small arrangements' || name.includes('holland');
        });
  ...
  return (
    <div className={`hollandsmallarrangements-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
