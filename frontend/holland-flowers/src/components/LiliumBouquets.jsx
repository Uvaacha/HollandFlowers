...
const LiliumBouquets = () => {
  ...
  const translations = {
    en: {
      title: "Lilium Bouquets", subtitle: "Beautiful lilium bouquets for special occasions", badge: "LILIUM BOUQUETS",
    ...
    ar: {
      title: "باقات الليليوم", subtitle: "باقات ليليوم جميلة للمناسبات الخاصة", badge: "باقات ليليوم",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'lilium bouquets' || name.includes('lilium');
        });
  ...
  return (
    <div className={`liliumbouquets-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
