...
const CylinderVases = () => {
  ...
  const translations = {
    en: {
      title: "Cylinder Vases", subtitle: "Modern cylinder vase arrangements", badge: "CYLINDER VASES",
    ...
    ar: {
      title: "مزهريات اسطوانية", subtitle: "تنسيقات مزهريات اسطوانية عصرية", badge: "مزهريات اسطوانية",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'cylinder vases 10 to 20' || name.includes('cylinder');
        });
  ...
  return (
    <div className={`cylindervases-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
