...
const HollandStyle = () => {
  ...
  const translations = {
    en: {
      title: "Holland Style", subtitle: "Premium Dutch-style flower arrangements", badge: "HOLLAND STYLE",
    ...
    ar: {
      title: "ستايل هولندي", subtitle: "تنسيقات زهور بالستايل الهولندي الفاخر", badge: "ستايل هولندي",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'holland style' || name.includes('holland');
        });
  ...
  return (
    <div className={`hollandstyle-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
