...
const CrownForHead = () => {
  ...
  const translations = {
    en: {
      title: "Crown for Head", subtitle: "Beautiful flower crowns for special occasions", badge: "FLOWER CROWNS",
    ...
    ar: {
      title: "تاج للرأس", subtitle: "تيجان زهور جميلة للمناسبات الخاصة", badge: "تيجان زهور",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'crown for head' || name.includes('crown');
        });
  ...
  return (
    <div className={`crownforhead-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
