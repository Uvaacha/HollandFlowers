...
const FlowersWithMabkhar = () => {
  ...
  const translations = {
    en: {
      title: "Flowers with Mabkhar", subtitle: "Traditional flowers with authentic mabkhar", badge: "FLOWERS & MABKHAR",
    ...
    ar: {
      title: "زهور مع مبخرة", subtitle: "زهور تقليدية مع مبخرة أصيلة", badge: "زهور ومبخرة",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'flowers with mabkhar' || name.includes('flowers');
        });
  ...
  return (
    <div className={`flowerswithmabkhar-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
      <section className="hero-banner">
        <div className="hero-bg-decoration">
          <span className="floating-icon float-1">🕯️</span>
          <span className="floating-icon float-2">✨</span>
          <span className="floating-icon float-3">🌸</span>
        </div>
        <div className="container">
          <div className="hero-content">
            <span className="hero-badge"><span>🕯️</span>{t.badge}</span>
          ...
          <div className="content-layout">
            ...
            <div className="products-main">
              ...
              {loading ? (
                ...
                <div className="empty-state"><span className="empty-icon">🕯️</span><p>{t.noProducts}</p></div>
              ) : (
