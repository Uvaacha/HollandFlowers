...
const FlowersWithMabkhar = () => {
  ...
  const translations = {
    en: {
      title: "Flowers with Mabkhar",
      subtitle: "Traditional flowers with authentic mabkhar",
      badge: "FLOWERS & MABKHAR",
      filters: "Filters",
      clearAll: "Clear All",
    ...
    ar: {
      title: "زهور مع مبخرة",
      subtitle: "زهور تقليدية مع مبخرة أصيلة",
      badge: "زهور ومبخرة",
      filters: "التصفية",
      clearAll: "مسح الكل",
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Find the exact category - FLOWERS WITH MABKHAR
        const targetCategory = categories.find(cat => {
          const name = (cat.categoryName || cat.nameEn || cat.name || '').toLowerCase().trim();
          // Match exactly "flowers with mabkhar"
          return name === 'flowers with mabkhar';
        });
