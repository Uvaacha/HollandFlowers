...
const HeliumBalloons = () => {
  ...
  const translations = {
    en: {
      title: "Helium Balloons", subtitle: "Colorful helium balloons for celebrations", badge: "BALLOONS",
    ...
    ar: {
      title: "بالونات هيليوم", subtitle: "بالونات هيليوم ملونة للاحتفالات", badge: "بالونات",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'helium balloons' || name.includes('helium');
        });
  ...
  return (
    <div className={`heliumballoons-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
