...
const OrchidPlants = () => {
  ...
  const translations = {
    en: {
      title: "Orchid Plants", subtitle: "Elegant and long-lasting orchid plants", badge: "ORCHIDS",
    ...
    ar: {
      title: "نباتات الأوركيد", subtitle: "نباتات أوركيد أنيقة وطويلة العمر", badge: "أوركيد",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'orchid plants' || name.includes('orchid');
        });
  ...
  return (
    <div className={`orchidplants-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
