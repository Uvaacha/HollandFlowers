...
const YellowRoseBouquets = () => {
  ...
  const translations = {
    en: {
      title: "Yellow Rose Bouquets", subtitle: "Bright and cheerful yellow roses to brighten any day", badge: "YELLOW ROSES",
    ...
    ar: {
      title: "باقات الورد الأصفر", subtitle: "ورود صفراء مشرقة ومبهجة لإضاءة أي يوم", badge: "ورد أصفر",
    ...
    const fetchProducts = async () => {
      try {
        ...
        const targetCategory = categories.find(cat => {
          ...
          return name === 'yellow rose bouquet' || name.includes('yellow');
        });
  ...
  return (
    <div className={`yellowrosebouquets-page ${currentLang === 'ar' ? 'rtl' : ''}`}>
