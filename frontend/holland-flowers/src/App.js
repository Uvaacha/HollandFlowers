  ...
  const getProductDescription = (product) => {
    if (currentLang === 'ar') {
      ...
      if (product.descriptionAr && product.descriptionAr.trim()) {
        return product.descriptionAr.length > 100 
    ...
    if (product.shortDescriptionEn && product.shortDescriptionEn.trim()) {
    ...
    if (product.descriptionEn && product.descriptionEn.trim()) {
      return product.descriptionEn.length > 100 
